...
public abstract class ABasicBindFragment extends Fragment implements IntentFrame.FragFrame, IUICommandImpl {
    ...
    View inflaterView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        toastUtil = new ToastUtil(inflater.getContext());
        bindViews(view);
